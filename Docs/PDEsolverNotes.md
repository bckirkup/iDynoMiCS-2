...
This note describes how PDE solvers are used and the choice between transient and steady-state. For optional GPU acceleration of the multigrid (steady-state) solver, see [GPU_ACCELERATION.md](GPU_ACCELERATION.md).
...
Solutes are typically produced or consumed in one of three ways:
